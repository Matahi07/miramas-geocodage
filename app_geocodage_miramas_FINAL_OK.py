...
if uploaded_file:
    ...
    df["adresse_complete"] = df["numero_nouvelle"].astype(str).str.strip() + " " + df["voie_nouvelle"].str.strip() + ", Miramas, France"
...
if "df_geo" in st.session_state:
    ...
    basemap = st.selectbox("🗺️ Choisir le fond de carte", [
        "OpenStreetMap", "Esri World Imagery", "CartoDB Positron"
    ])
